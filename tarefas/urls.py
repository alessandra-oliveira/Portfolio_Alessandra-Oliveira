...
urlpatterns =  [
    ...
    path('v1/', views.tarefa_list_create_fbv, name='lista-fbv', ),

    path('v1/<int:pk>/', views.tarefa_detail_fbv, name='detalhe-fbv', ),

    # ─── Estilo 2: Class-Based Views (APIView) ───
    path('v2/', views.TarefaListCreateAPIView.as_view(), name='lista-cbv', ),

    path('v2/<int:pk>/', views.TarefaDetailAPIView.as_view(), name='detalhe-cbv', ),
